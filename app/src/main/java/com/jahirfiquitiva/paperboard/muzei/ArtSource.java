...
public class ArtSource extends RemoteMuzeiArtSource {
    ...
    private static final String ARTSOURCE_NAME = "Alium Lite - Icon Pack";
    private static final String JSON_URL = "https://raw.githubusercontent.com/StudiosRevolutionTech/Json_Files/master/wallpaper.json";
