...
public class MainActivity extends AppCompatActivity {
    ...
    public String aliumPro = "com.studiosrevtech.aliumpro";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AccountHeader headerResult = new AccountHeaderBuilder()
                .withActivity(this)
                .withHeaderBackground(R.drawable.portada_home_2)
                //.withSelectionFirstLine(getResources().getString(R.string.app_long_name))
                .withSelectionSecondLine(getResources().getString(R.string.app_long_name))
    ...
    public void versionPremium () {
        new MaterialDialog.Builder(this)
                .title(R.string.version_premium)
                .content(R.string.version_premium_desc)
                ...
                .callback(new MaterialDialog.ButtonCallback() {
                    ...
                    public void onPositive(MaterialDialog dialog) {
                        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(MARKET_URL + aliumPro));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.buy_pro:
                Intent versionPro = new Intent(Intent.ACTION_VIEW, Uri.parse(MARKET_URL + getResources().getString(R.string.app_two_package)));
                startActivity(versionPro);
                break;
